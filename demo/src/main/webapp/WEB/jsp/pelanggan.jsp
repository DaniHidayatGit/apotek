                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <form:form action="/searchPelanggan" modelAttribute="cari" method="POST">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                <c:forEach var="var" items="${Pelanggan}">
                                    <tr>
                                        <td> ${var.id_peg} </td>
                                        <td> ${var.nama} </td>
                                        <td> ${var.jk} </td>
                                        ...
                                        <td>
                                            <div class="col-md-auto">
                                                <c:url var="update" value="/updatePelanggan">
                                                    <c:param name="id" value="${var.id_peg}"/>
                                                </c:url>
                                                <a href="${update}" class="btn btn-success btn-block"> Edit </a>

                                                <c:url var="delete" value="/deletePelanggan">
                                                    <c:param name="id" value="${var.id_peg}"/>
                                                </c:url>
