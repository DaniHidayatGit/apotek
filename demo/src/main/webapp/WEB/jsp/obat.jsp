                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <form:form action="/searchObat" modelAttribute="cari" method="POST">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td> ${var.hargabeli} </td>
                                    <td> ${var.hargajual} </td>
                                    <td> ${var.kedaluwarsa} </td>
                                    <td> ${var.pemasok} </td>
                                    <td>
                                        <div class="col-md-auto">
                                            <c:url var="update" value="/updateObat">
                                                <c:param name="id" value="${var.id_obat}"/>
                                            </c:url>
                                            <a href="${update}" class="btn btn-success btn-block"> Edit </a>

                                            <c:url var="delete" value="/deleteObat">
                                                <c:param name="id" value="${var.id_obat}"/>
                                            </c:url>
                                            <a href="${delete}" class="btn btn-danger btn-block"> Hapus </a>
                                        </div>
                                    </td>
                                </tr>
                                </c:forEach>
