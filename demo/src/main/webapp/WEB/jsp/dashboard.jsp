        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800 font-weight-bold"> Selamat Datang di Sistem Informasi Apotek </h1>
                </div>

                <!-- top tiles -->
                <div class="row tile_count mb-3" style="text-align: center;">
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-medkit"></i> Total Obat</span>
                        <div class="count">${jumlahObat}</div>
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fas fa-hospital-alt"></i> Total Kategori</span>
                        <div class="count">${jumlahKategori}</div>
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-user"></i> Total Pemasok</span>
                        <div class="count">${jumlahPemasok}</div>
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-user-friends"></i> Total Pegawai</span>
                        <div class="count">${jumlahPegawai}</div>
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-user-check"></i> Total Member</span>
                        <div class="count">${jumlahPelanggan}</div>
                    </div>
                </div>

                <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-5">
                    <h1 class="h5 mb-0 text-gray-800"> Informasi Obat </h1>
                </div>
                <div class="row tile_count mb-3" style="text-align: center;">
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-medkit"></i> Obat yang telah habis</span>
                        <div class="count">${emptyStock}</div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-medkit"></i> Obat yang masih tersedia</span>
                        <div class="count">${ayaStock}</div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-medkit"></i> Obat yang kadaluarsa</span>
                        <div class="count">${countExp}</div>
                    </div>
                </div>
                <div class="row tile_count mb-3" style="text-align: center;">
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-medkit"></i> Obat yang tersisa sedikit </span>
                        <div class="count">${minStock}</div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-medkit"></i> Total Stock Obat</span>
                        <div class="count">${sumStock-sumExp}</div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-medkit"></i> Total Obat Telah Kadaluarsa</span>
                        <div class="count">${sumExp}</div>
                    </div>
                </div>

                <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-5">
                    <h1 class="h5 mb-0 text-gray-800"> Informasi Member </h1>
                </div>
                <div class="row tile_count mb-3" style="text-align: center;">
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-user-check"></i> Member Classic</span>
                        <div class="count">${classic}</div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-user-check"></i> Member Silver</span>
                        <div class="count">${silver}</div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-user-check"></i> Member Gold</span>
