...
<c:choose>
    ...
    <c:when test="${sessionScope.email != isAdmin}">
...
<body id="page-top">
<form:form id="peg" action="/saveUpdatePegawai" modelAttribute="pegawaiDto" method="POST">
    <form:hidden path="id_peg" value="${pegawaiDto.id_peg}"/>
    <!-- Page Wrapper -->
    <div id="wrapper">
                            ...
                            <div class="card shadow mb-5">
                                <form class="user col-md-auto">
                                    ...
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Nama Pegawai : </i>
                                        <form:input path="nama" type="text" placeholder="Nama Pegawai" class="form-control form-control-user" pattern="[A-Za-z ]{3,30}" required="required"/>
                                    </div>
                                    <br>
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Jenis Kelamin : </i><br>
                                        <form:radiobutton path="jk" name="jk" value="Laki-laki" required="required"/> Laki-laki
                                        <form:radiobutton path="jk" name="jk" value="Perempuan"/> Perempuan
                                    </div>
                                    <br>
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Alamat : </i>
                                        <form:input path="alamat" type="text" placeholder="Alamat" class="form-control form-control-user" pattern="{1,30}" required="required"/>
                                    </div>
                                    <br>
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Nomor Telepon : </i>
                                        <form:input path="nohp" type="text" placeholder="Nomor Telepon" class="form-control form-control-user" pattern="[0-9]{11,13}" required="required"/>
                                    </div>
                                    <br>
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Email : </i>
                                        <form:input path="email" type="email" placeholder="Email" class="form-control form-control-user" pattern="{1,30}" required="required"/>
                                    </div>
                                    <br>
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Password : </i>
                                        <form:input path="password" type="text" placeholder="Password" class="form-control form-control-user" pattern="{1,30}" required="required"/>
                                    </div>
                                    <br>
